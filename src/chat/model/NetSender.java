...
public class NetSender {
		    ...
		    public boolean send(String string, InetAddress address) throws IOException
		    {
		        ...
		        int bLength = string.length() > NetClient.s_BUFFER_SIZE ? NetClient.s_BUFFER_SIZE : string.length();
		        ...
		        try
		        {
		            ...
		            {
		                m_socket.send(new DatagramPacket(buffer, bLength, address, NetClient.s_UDP_PORT_R));
		            }
		            res = true;
		        }
